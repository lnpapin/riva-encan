// api/lots.js — Récupérer et gérer les lots
...
export default async function handler(req, res) {
  ...
  // ── GET : récupérer tous les lots avec leurs enchères ──
  if (req.method === 'GET') {
  ...
  // ── POST : ajouter un nouveau lot (admin) ──
  if (req.method === 'POST') {
